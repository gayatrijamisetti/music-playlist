...
class App extends React.Component {
  ...
  getSearchItem = event => {
    ...
    this.setState({searchInput: event.target.value, initialList: filteredItems})
  }

  deleteItem = id => {
    const {initialList} = this.state
    const filteredItems = initialList.filter(eachItem => eachItem.id !== id)
    this.setState({initialList: filteredItems})
  }
